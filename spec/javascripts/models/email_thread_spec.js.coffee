  ...
  describe "#initialize", ->
    ...
    describe "emailThreadUID", ->
      describe "attributes", ->
        ...
        it "sets up the url", ->
          expect(@emailThreadTemp.url).toEqual("/api/v1/email_threads/show/" + @attributes.uid)
      ...
      describe "options", ->
        ...
        it "sets up the url", ->
          expect(@emailThreadTemp.url).toEqual("/api/v1/email_threads/show/" + @options.emailThreadUID)
