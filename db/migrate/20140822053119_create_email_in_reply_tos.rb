class CreateEmailInReplyTos < ActiveRecord::Migration
  def change
    ...
    add_index :email_in_reply_tos, :email_account_id
    add_index :email_in_reply_tos, :email_id
    add_index :email_in_reply_tos, [:email_id, :in_reply_to_message_id], unique: true
    add_index :email_in_reply_tos, [:email_account_id, :in_reply_to_message_id],
              name: 'index_email_in_reply_tos_ea_id_and_irtm_id'
  end
end
