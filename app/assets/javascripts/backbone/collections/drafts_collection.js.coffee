class TuringEmailApp.Collections.DraftsCollection extends Backbone.Collection
  ...
  updateDraft: (shouldSend=false) ->
    ...
    if TuringEmailApp.currentEmailThread? and
       TuringEmailApp.currentEmailThread.get("uid")? and
       TuringEmailApp.emailThreads? and
       TuringEmailApp.emailThreads.drafts? and
       TuringEmailApp.emailThreads.drafts.models? and
       TuringEmailApp.emailThreads.drafts.models[0].attributes?
